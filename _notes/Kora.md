...
Way of the Pistolero Skill
```pf2e-stats
##### [[Ten Paces|Ten Paces]] `[one-action]`
```
...
```pf2e-stats
##### [[Raconteur's Reload|Raconteur's Reload]] `[one-action]`
```
[[Singular Expertise|Singular Expertise]]
...
#### Class Feat:
```pf2e-stats
##### [[Quick Draw|Quick Draw]] `[one-action]`
```
#### Skill Feat:
...
#### Class Feat:
```pf2e-stats
##### [[Paired Shots|Paired Shots]] `[two-action]`
```
#### Skill Feat:
...
#### Ancestry Feat:
```pf2e-stats
##### [[Long-Nosed Form|Long-Nosed Form]] `[one-action]`
```
#### Extra:
[[Gunslinger Weapon Mastery|Gunslinger Weapon Mastery]]
### Level 6
#### Class Feat:
```pf2e-stats
